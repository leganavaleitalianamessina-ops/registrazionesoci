...
- **Landing page `/promozione`**: attiva in produzione, visualizza solo il poster promozionale a larghezza piena (`w-full h-auto`), pagina scrollabile in altezza, senza loghi/link.
